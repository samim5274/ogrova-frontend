...
const PaymentMethods = () => import('../components/e-commerce/information/payment-method.vue');
...
const routes = [
  ...
  { path: '/payment-methods', component: PaymentMethods, meta: { title: "Payments Methods - OGROVA | Bangladesh's Smart Online Marketplace"} },
  { path: '/shipping-information', component: ShippingInfo, meta: { title: "Shipping Information - OGROVA | Bangladesh's Smart Online Marketplace"} },
