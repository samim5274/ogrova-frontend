    ...
    <footer class="bg-white dark:bg-[#0f172a] border-t border-slate-200 dark:border-white/10 transition-colors duration-500">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <router-link to="/" class="flex items-center gap-3 group">
                ...
                <img src="/logo/logo.avif" alt="Logo" class="w-6 h-6 object-contain dark:hidden" />
                <img src="/logo/white-logo.avif" alt="Logo" class="hidden dark:block w-6 h-6 object-contain drop-shadow-[0_4px_8px_rgba(163,217,33,0.3)]" />
                </div>
