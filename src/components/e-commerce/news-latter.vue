<template>
    <footer class="mt-1 bg-slate-50 dark:bg-[#070708] border-t border-slate-200/60 dark:border-slate-900 transition-colors duration-500">
        <section class="py-12 bg-slate-50 dark:bg-[#070708] transition-colors duration-300">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                    
                    <!-- Free Shipping -->
                    <div class="group flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-emerald-500 dark:hover:border-orange-500 transition-all duration-300">
                        <div class="w-14 h-14 flex items-center justify-center rounded-full bg-emerald-50 dark:bg-orange-500/10 text-emerald-600 dark:text-orange-500 mb-4 group-hover:scale-110 transition-transform duration-300">
                            <!-- Truck Icon -->
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">Free Shipping</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-[240px]">
                    ...
                    <div class="group flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-emerald-500 dark:hover:border-orange-500 transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">24x7 Support</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-[240px]">
                    ...
                    <div class="group flex flex-col items-center text-center p-6 bg-white dark:bg-gray-800 rounded-2xl border border-slate-200 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-emerald-500 dark:hover:border-orange-500 transition-all duration-300">
                        ...
                        <h3 class="text-lg font-bold text-gray-800 dark:text-gray-100 mb-2">Secure Payment</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400 leading-relaxed max-w-[240px]">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-12 gap-8 pb-12 text-slate-600 dark:text-slate-400">
                ...
                <div class="lg:col-span-2">
                    ...
                    <ul class="space-y-2.5 text-sm font-medium">
                        ...
                        <li><router-link to="/payment-methods" class="hover:translate-x-1 text-slate-500 dark:text-slate-400 transition-all duration-300 inline-block hover:text-emerald-600 dark:hover:text-orange-400">Payment Methods</router-link></li>
                ...
                <div class="lg:col-span-2 space-y-5">
                    <div>
                        ...
                        <ul class="space-y-2.5 text-sm font-medium">
                            ...
                            <li><router-link to="/cancellation" class="hover:translate-x-1 text-slate-500 dark:text-slate-400 transition-all duration-300 inline-block hover:text-emerald-600 dark:hover:text-orange-400">Cancellation</router-link></li>
